...
<footer class="footer-area pt-60">
    <div class="footer-area-inner bg-img" style="background-image: url({{ asset($activeTemplateTrue . 'images/shapes/footer-05.png') }});">
        <div class="footer-area__bg">
        </div>
        <div class="footer-shape">
            <img src="{{ frontendImage('footer', @$footer->data_values->image, '240x580') }}" alt="">
        </div>
            ...
            <div class="container">
                <div class="row gy-3">
                    <div class="col-md-12 text-center">
                        <div class="bottom-footer-text"> &copy; {{ date('Y') }} <a href="{{ route('home') }}">{{ __(gs('site_name')) }}</a> @lang('All Rights Reserved').</div>
                    </div>
                </div>
            </div>
        </div>
