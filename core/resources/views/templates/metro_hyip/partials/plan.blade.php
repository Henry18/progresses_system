    ...
    <div class="plan-item__body">
      <div class="plan-item__info">
        ...
        <div>
          ...
          <p class="plan-item__amount">@lang('Min'): {{ showAmount($data->minimum) }} </p>
          <p class="plan-item__amount">@lang('Max'): {{ showAmount($data->maximum) }} </p>
          @else
          <p class="plan-item__amount">@lang('Fixed'): {{ showAmount($data->fixed_amount) }} </p>
          @endif
        </div>
      </div>
      <ul class="plan-item__list">
        ...
        <li class="plan-item__list-inner">
          @if ($data->lifetime == 0)
          @lang('Total')
          {{ $data->interest * $data->repeat_time }}{{ $data->interest_type == 1 ? '%' : ' ' . __(gs('cur_text')) }}
...
<div class="modal custom--modal fade" id="investModal">
  <div class="modal-dialog modal-lg modal-content-bg">
    <div class="modal-content">
      ...
      <form action="{{ route('user.invest.submit') }}" class="disableSubmission" method="post">
        @csrf
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form--control methodWallet" name="wallet_type" required>
                  ...
                  <option value="deposit_wallet">@lang('Deposit Wallet - ' . showAmount(auth()->user()->deposit_wallet))
                  </option>
                  @endif
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="number" step="any" class="form-control form--control investAmount" name="amount"
                    required>
              ...
              <div class="form-group">
                <div class="form-group">
                  ...
                  <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                    data-bs-toggle="toggle" data-on="@lang('Yes')" data-off="@lang('No')" name="hold_capital">
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 compoundInterest">
              <div class="form-group">
                ...
                <small class="fst-italic text--info"><i class="las la-info-circle"></i> @lang('Your interest will add to
                  the investment capital amount for a specific time that you\'re entering.')</small>
              </div>
            </div>
            ...
            <div class="col-md-6 investTime">
              <div class="form-group">
                ...
                <small class="fst-italic text--info"><i class="las la-info-circle"></i> @lang('You can set your
                  investment as a scheduler or invest instant.')</small>
              </div>
            </div>
            @endif
          </div>
          ...
          <div class="row schedule">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <small class="fst-italic text--info"><i class="las la-info-circle"></i> @lang('Set how many times you
                  want to invest.')</small>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <small class="fst-italic text--info"><i class="las la-info-circle"></i> @lang('Set a frequency at which
                  you prefer to make investments.')</small>
              </div>
            </div>
          </div>
          @endif
        ...
        <div class="modal-footer">
          ...
          @else
          <a href="{{ route('user.login') }}" class="btn btn--base pill w-100 text-center">@lang('At first sign in your
            account')</a>
          @endif
        </div>
      </form>
...
(function($) {
  ...
  $('.investModal').click(function() {
    ...
    plan = $(this).data('plan');
    console.log(plan);
    modal.find('.cap_plan').attr('title', '@lang('
      By activating this option you indicate that you want to receive your invested balance in
      equal fractions in the last ')' + ' ' + (plan.repeat_time - plan.capital_months_return) + ' ' + '@lang('
      months of the plan ')');
