                    ...
                    <tbody>
                        @forelse($withdraws as $withdraw)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn--base btn--sm detailBtn" data-user_data="{{ json_encode($withdraw->withdraw_information) }}" @if ($withdraw->status == 3) data-admin_feedback="{{ $withdraw->admin_feedback }}" @endif>
