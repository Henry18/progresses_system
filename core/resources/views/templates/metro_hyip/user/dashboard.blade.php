            ...
            <div class="col-xxl-4 col-xl-6 col-md-6">
                <div class="dashboard-item">
                    ...
                    <div class="dashboard-item__investment">
                        ...
                        <h3 class="dashboard-item__investment-number"> {{ showAmount($totalInvestByWallet) }}</h3>
                    </div>
                    <div class="d-flex align-items-start justify-content-center">
                        <div class="dashboard-item__wallet">
                            <span class="dashboard-item__wallet-title"> @lang('Deposit Wallet') </span>
                            <h4 class="dashboard-item__wallet-number">{{ showAmount($depositWalletInvests) }} </h4>
                            <span class="dashboard-item__wallet-persentage"><span class="dashboard-item__wallet-icon"><i class="fas fa-long-arrow-alt-up"></i></span> {{ showAmount($depositWallet, currencyFormat: false) }}%</span>
                        </div>
                        <div class="dashboard-item__wallet two">
                            <span class="dashboard-item__wallet-title"> @lang('Interest Wallet') </span>
                            <h4 class="dashboard-item__wallet-number">{{ showAmount($interestWalletInvests) }} </h4>
                            <span class="dashboard-item__wallet-persentage"><span class="dashboard-item__wallet-icon"><i class="fas fa-long-arrow-alt-up"></i></span> {{ showAmount($interestWallet, currencyFormat: false) }}%</span>
                        </div>
                    </div>
                </div>
            </div>
